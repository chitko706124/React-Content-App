  ...
  return (
    <>
      <div className=" flex flex-col lg:flex-row items-center justify-center gap-5 mt-[50px]">
        <div>
          <img src={welcome} className="w-[500px] h-[60vh] " alt="" />
        </div>
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <p className="md:w-[300px] w-full lg:w-[550px] text-center text-gray-700 ">
            Your account has been found by server.Let's make contacts and
            contacts with each other.Deliver your meaasges
          </p>
          <Link to={`/`}>
